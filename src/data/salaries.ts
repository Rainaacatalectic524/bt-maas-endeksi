...
export const roles: Role[] = [
  ...
  { name: 'Data Analyst',      jr: 42,  mid: 75,  sr: 125, n: 55,  cat: 'data' },
  { name: 'DBA',               jr: 48,  mid: 88,  sr: 145, n: 28,  cat: 'infra' },
  { name: 'Product Manager',   jr: 55,  mid: 100, sr: 168, n: 95,  cat: 'mgmt' },
  { name: 'Product Owner',     jr: 50,  mid: 92,  sr: 155, n: 63,  cat: 'mgmt' },
  { name: 'UX/UI Tasarımcı',   jr: 38,  mid: 68,  sr: 115, n: 47,  cat: 'dev' },
  { name: 'Scrum Master',      jr: 45,  mid: 82,  sr: 140, n: 31,  cat: 'mgmt' },
  { name: 'Business Analyst',  jr: 42,  mid: 76,  sr: 128, n: 41,  cat: 'mgmt' },
